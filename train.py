...
if __name__== "__main__":
    ...
    parser.add_argument('-i', '--input_dir', action='store', dest='input_dir', default='/content/drive/My Drive/resized_images' ,
                    help='Path for input images')
                    
    parser.add_argument('-o', '--output_dir', action='store', dest='output_dir', default='/content/drive/My Drive/output/' ,
                    help='Path for Output images')
    
    parser.add_argument('-m', '--model_save_dir', action='store', dest='model_save_dir', default='/content/drive/My Drive/new_model/' ,
                    help='Path for model')
